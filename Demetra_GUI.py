...
if __name__ == '__main__':
    ...
    lbl_hello_create_final_check_egisso = Label(create_final_check_egisso_frame_description,
                                                text='Центр опережающей профессиональной подготовки Республики Бурятия\n'
                                                     ...
                                                     'в файлах выверки фактов назначений по пересекающимся периодам.\n'
                                                     'Дубли ищутся по Код ЛМСЗ, период "с" и "по" и одинаковой сумме.\n'
                                                     'Для ручной проверки ищутся записи с одинаковыми\n'
                                                     'Код ЛМСЗ, период "с" и "по" и разными суммами.\n\n'
                                                     'Специалисты внесшие особый вклад в создание этой функции:\n'
                                                     'Руденко Оксана Анатольевна - Социальный фонд Республики Бурятия\n'
                                                     'Цыбендоржиева Оксана Аюшиевна - Министерство образования и науки РБ'
                                                , width=60)
    ...
    lbl_hello_create_fix_data_for_girvu = Label(create_fix_data_for_girvu_frame_description,
                                                text='Центр опережающей профессиональной подготовки Республики Бурятия\n'
                                                     'Поиск и исправление БАЗОВЫХ ошибок в файлах xlsx для ГИР ВУ РБ.\n'
                                                     'Программа удаляет лишние пробелы, лишние символы и т.п.\n'
                                                     'Программа НЕ исправляет неправильные персональные данные\n'
                                                , width=60)
